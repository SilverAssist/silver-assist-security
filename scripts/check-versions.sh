...
echo "• If versions are inconsistent, run: ${YELLOW}./scripts/update-version.sh ${MAIN_VERSION}${NC}"
echo "• To update to a new version, run: ${YELLOW}./scripts/update-version.sh <new-version>${NC}"
